    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form action="{{ route('contact_backend.store') }}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="contact_us_text" id="contact_us_text"></textarea>
                </div>
                      ...
                      <form action="{{route('contact_backend.update', $val->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="form-group">
                              <label for="email">Email:</label>
                              <input class="form-control" type="email" name="email" id="email" value="{{$val->email}}">
                            </div>
                            <div class="form-group">
                              <label for="phone">Phone:</label>
                              <input class="form-control" type="text" name="phone" id="phone" value="{{$val->phone}}">
                            </div>
                            <div class="form-group">
                              <label for="address">Addreess:</label>
