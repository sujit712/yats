        ...
        <div class="panel panel-default">
            <div class="panel-heading">Portfolio</div>
                <div class="panel-body">
                    <form action="{{action('PortfolioController@create')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                        <div class="row">
        ...
        <div class="panel-heading">Portfolio Show</div>
            <div class="panel-body">         
                <table class="table">
                    ...
                    <td>
                    <form action="{{action('PortfolioController@destroy')}}" method="post">
                        {{csrf_field()}}
                      ...
                      <div class="modal-dialog model-lg">
                        ...
                        <div class="modal-header">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{action('PortfolioController@edit')}}" method="post" enctype="multipart/form-data">
